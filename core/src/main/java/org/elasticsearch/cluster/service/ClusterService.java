...
public class ClusterService extends AbstractLifecycleComponent {
    ...
    //updateTask 为完整的 task，包括 config，executor 和 listener 的实现
     ...
     *
     * @param source   the source of the cluster state update task
     * @param task     the state needed for the cluster state update task 完整的 task
     * @param config   the cluster state update task configuration 配置信息是超时和优先级
